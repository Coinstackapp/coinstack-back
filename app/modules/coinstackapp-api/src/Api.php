...
class Api extends MySQL {
  ...
  public function _getListCoinLimit($limit, $currency = 'USD'){
    ...
    $listCoin = [];
    $CryptoApi = new CryptoApi(null, [$currency, '$'], $this->_getApp());
    foreach ($r as $key => $datacoin) {
      $CryptoCoin = new CryptoCoin($CryptoApi, $datacoin['symbol_coinlist'], $datacoin, $this->_getApp());
  ...
  public function _getDataCoinHistorical($symbol, $currency = 'USD', $duration = '86400'){
    ...
    $CryptoApi = new CryptoApi(null, [$currency, '$'], $this->_getApp());
    $CryptoCoin = new CryptoCoin($CryptoApi, $symbol, null, $this->_getApp());
    $CryptoGraph = new CryptoGraph($CryptoCoin->_getHistoMin(1440));
  ...
  public function _getSymbol($from, $to){
    ...
    $CryptoApi = new CryptoApi(null, [$to, '$'], $this->_getApp());
    $CryptoCoin = new CryptoCoin($CryptoApi, $from, null, $this->_getApp());
  ...
  public function _getTopPairSymbol($symbol){
    ...
    $CryptoApi = new CryptoApi(null, ['USD', '$'], $this->_getApp());
    $CryptoCoin = new CryptoCoin($CryptoApi, $symbol, null, $this->_getApp());
