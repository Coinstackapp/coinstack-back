 ...
 * Google Oauth Class
 *
 * @package Coinstackapp
 * @author Santosh Manivannan <santosh@coinstackapp.com>
 */
class GoogleOauth extends MySQL
{
    ...
    public function _getProvider()
    {
        ...
        $this->provider = new League\OAuth2\Client\Provider\Google([
            ...
            'redirectUri'  => APP_URL.'/app/modules/coinstackapp-googleoauth/src/actions/callback.php'
        ]);
